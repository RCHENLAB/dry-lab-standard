...
u228876
```
## Working Remotely (setting up your VPN)
...
## 6. Get to know a text editor on Linux
It is important to edit files on Linux efficiently, and Vim or Emacs are typically used. It is important to know basic editing operations include insert, copy, paste, selection, delete, move, search, and replace. Some cheat sheets will help remember common operations. Such as https://devhints.io/vim. 
...
## 8. Tips to easily download files from the server to your computer 
...
**Port:** 22 (sometimes we need to take in blank). 
...
## Submit interactive and batch jobs to Slurm 
